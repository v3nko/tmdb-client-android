...
class DiscoveryViewModel : BaseViewModel() {
    ...
    val topRevenueMovies: LiveData<PagedList<Movie>>
    ...
    val mostRecentMovies: LiveData<PagedList<Movie>>
    ...
    fun displayMovieDetails(movie: Movie) {
        router.navigateToDetailsRoot(MovieDetailsScreen(movie), TransitionInfo.default())
    }
